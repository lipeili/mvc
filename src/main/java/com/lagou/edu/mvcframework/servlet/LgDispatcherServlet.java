    ...
    private void initHandlerMapping() {
        ...
        for(Map.Entry<String,Object> entry: ioc.entrySet()) {
            ...
            for (int i = 0; i < methods.length; i++) {
                ...
                Handler handler = new Handler(null,entry.getValue(),method, Pattern.compile(url));
...
//        method.invoke() //
        ...
        if (!isAuth(req.getParameter("username"), handler.getAuths())) {
    ...
    private boolean isAuth (String userName, String[] auths) {
    ...
    private void bindAuth (Method method, Handler handler) {
        ...
        handler.setAuths(security.value());
